...
public class Motorcycle {
    ...
    @Size(max = 20, message = "VIN must be 20 characters in length.")
    private String vin;
    @NotEmpty(message = "You must supply a value for make.")
    @Size(max = 20, message = "make can be up to 20 characters")
    private String make;

    @NotEmpty(message = "You must supply a value for model.")
    @Size(max = 20, message = "model can be up to 20 characters")
    ...
    @Size(max = 20, message = "color can be up to 20 characters")
